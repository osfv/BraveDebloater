...
- Added `.github/workflows/release.yml`: pushing a `vX.Y.Z` tag reruns the checks, verifies the tag against `$ToolVersion` and `CHANGELOG.md`, and publishes the release archive, `SHA256SUMS.txt`, and notes automatically.
